<!-- Almanac Select -->
<template>
  <div class="zp-almanac-select" @mousewheel="expand = false" @click="toggleList" @blur="onBlur" @mouseleave="onBlur" ref="dpSelf">
    ...
    <i :class="['zp-icon-clear', {'zp-hide': !startDate || !endDate}]" @click.stop="clearDate"></i>
